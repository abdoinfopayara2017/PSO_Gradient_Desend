...
for subsetindex in range(10):
    ...
    # E:/LUNA 16/subset0\1.3.6.1.4.1.14519.5.2.1.6279.6001.105756658031515062000744821260.mhd   
    file_list_path=[]
    for i in range(len(file_list)):
        file_list_path.append(file_list[i][0:-4])
        #  E:/LUNA 16/subset0\1.3.6.1.4.1.14519.5.2.1.6279.6001.105756658031515062000744821260

    # The locations of the nodes
    luna_csv_path = "E:/LUNA 16/"
